...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002389519814'))  #Movie Update Channel Id
...
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1002389519814')) 
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002869423722')).split()]
